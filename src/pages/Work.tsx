      ...
      <div className="lg:mr-8 mt-8 lg:mt-[200px] flex-auto lg:w-1/2 justify-start items-end px-5 text-center h-fit">
        <Card className="rounded-lg shadow-lg bg-zinc-50 dark:bg-slate-900 md:mx-10 lg:mx-0">
          ...
          <CardFooter className="pt-5  grid grid-flow-col-reverse grid-rows-3 grid-cols-3 gap-5 md:gap-3 lg:flex lg:justify-center lg:items-center text-center">
            ...
            <Badge className="text-black bg-blue-500 hover:bg-slate-400 dark:hover:bg-slate-400 shadow-lg text-center">
              Typescript
            </Badge>
            <Badge className="text-black bg-green-600 hover:bg-slate-400 dark:hover:bg-slate-400 shadow-lg text-center">
              Django
            </Badge>
            <Badge className="text-black bg-blue-500 hover:bg-slate-400 dark:hover:bg-slate-400 shadow-lg text-center">
              Docker
            </Badge>
            <Badge className="text-black bg-red-500 hover:bg-slate-400 dark:hover:bg-slate-400 shadow-lg text-center col-span-2">
