...
function ProjectsPage() {
  ...
  return (
    <section id={t("Navbar.Projects")} className="h-screen flex flex-col">
      <div className="justify-center items-center p-10 mx-5 mt-28 bg-gradient-to-b from-gray-200 via-gray-200 to-gray-300 dark:bg-gradient-to-b dark:to-slate-950 dark:from-slate-950 rounded-xl shadow-xl">
