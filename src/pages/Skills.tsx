  ...
  return (
    <div id="Skills" className="min-h-screen flex flex-col lg:flex-row">
      ...
      <div className="lg:mr-8 mt-8 lg:mt-[200px] flex-auto lg:w-1/2 justify-start items-end px-5 text-center">
        <h2 className="text-gray-950 dark:text-gray-50 text-1xl lg:text-2xl font-bold leading-[30px] ">
          Technologies / Libraries i've worked with:
        </h2>
        <div className="text-gray-950 dark:text-gray-50 text-1xl lg:text-2xl font-medium leading-[30px] flex flex-row pt-10 gap-5 w-full justify-center">
          <StackIcons />
        </div>
      </div>
    </div>
