  ...
  return (
    <div className="flex gap-5 justify-between">
      ...
      <motion.a
        ...
        target="_blank"
        className="flex gap-1 shadow-lg p-1 border-solid border-2 border-slate-300 dark:bg-slate-950 dark:border-slate-900 rounded-md h-fit w-fit hover:bg-gradient-to-r hover:from-cyan-500 hover:to-blue-400"
        whileHover={{ scale: 1.1 }}
        whileTap={{ scale: 0.9 }}
      >
