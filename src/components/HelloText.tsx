...
function HelloText() {
  ...
  return (
    <div className="lg:ml-[7vw] md:ml-[7vw] mt-[33vh] text-center md:text-left lg:text-left justify-end items-start">
      <span className="text-zinc-400 text-2xl lg:text-2xl font-medium leading-[60px] tracking-[1px] uppercase">
      ...
      <span className="text-zinc-950 dark:text-zinc-50 text-2xl lg:text-2xl font-medium leading-[60px]">
        {t("IntroPage.job")}
      </span>
    </div>
  );
